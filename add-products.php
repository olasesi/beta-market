...
$q = mysqli_query($connect,"INSERT INTO products(products_name, products_price, products_sub_categories, products_promo, products_deals,products_new_arrivals, products_best_sellers, products_popular, products_short_description, products_long_description, products_image) 
VALUES ('".$products_name."','".$products_price."','".$cat."','".$hot_promo."','".$deals_of_the_day."','".$new_arrivals."','".$best_sellers."','".$most_popular."','".$products_desc_short."','".$products_desc_long."', '".$image_uploaded."')") or die(db_conn_error);
    if (mysqli_affected_rows($connect) == 1) {
...
?>
 ...
 <div class="ps-section__right">
                    ...
                    ?>
                       ...
                       <?php        
                         $products_cat_select = mysqli_query($connect, "SELECT products_categories_name FROM products_categories") or die(db_conn_error);
                        ...
                        while($while_products_cat = mysqli_fetch_array($products_cat_select)){
                            ...
                            echo '<option value="'.$while_products_cat['products_categories_name'].'">'.$while_products_cat['products_categories_name'].'</option>';
