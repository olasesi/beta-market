...
?>
                ...
                <div class="header__center">
                    <form class="ps-form--quick-search" action="search.php" method="GET">
                        ...
                        <input class="form-control" type="text" placeholder="I'm shopping for..." id="input-search" name="products_search_input"/>
                        <button type="submit" name="products_search_button">Search</button>
